  ...
  return (
    <div className={styles.container}>
      ...
      <nav className={styles.navbar} style={{ backgroundColor: 'rgba(0, 0, 0, 0)' }}>
        ...
        <div className={styles.linksContainer}>
          <Link href="#infos"><span className={styles.navLink}>Infos</span></Link>
          <div className={styles.linkSeparator}></div>
          <Link href="#benefits"><span className={styles.navLink}>Vorteile</span></Link>
          <div className={styles.linkSeparator}></div>
          <Link href="#solutions"><span className={styles.navLink}>Lösungen</span></Link>
          <div className={styles.linkSeparator}></div>
          <Link href="#requirements"><span className={styles.navLink}>Voraussetzungen</span></Link>
          <div className={styles.linkSeparator}></div>
      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroText}>
          ...
          <p>Entdecken Sie intelligente Lösungen für ein nachhaltiges Zuhause.</p>
      ...
      <section id="infos" className={styles.infoSection}>
        ...
        <button className={styles.learnMore}>Erfahre mehr über unsere KI-Lösungen</button>
      </section>
    ...
    <section className={styles.robotSection}>
      ...
      <section className={styles.videoSection}>
        <h1 className={styles.videoTitle}>Wie KI-gesteuerte Systeme den Energieverbrauch überwachen und optimieren</h1>
        <video
      ...
      <section id="benefits" className={styles.cardsSection}>
        <h1 className={styles.sectionCardTitle}>Vorteile einer KI-Smart Energy Lösung</h1>
        <p className={styles.sectionDescription}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>

        <div className={styles.cardsContainer}>
          {/* Karte 1 */}
          <div className={styles.card}>
            <Image src="/images/AI hand mit glühbirne.png" alt="Energie Management" width={326} height={200}/>
          ...
          {/* Karte 2 */}
          <div className={styles.card}>
            <Image src="/images/weltkugel natur.png" alt="Nachhaltigkeit" width={326} height={200}/>
            <div className={styles.cardContent}>
          ...
          {/* Karte 3 */}
          <div className={styles.card}>
            <Image src="/images/Oink.png" alt="Fördermöglichkeiten" width={326} height={200}/>
            <div className={styles.cardContent}>
...
<section className={styles.compatibilitySection}>
    ...
    <div className={styles.compatibilityGrid}>
        ...
        <div className={styles.compatibilityItem}>
            <img src="/images/Samsung.svg" alt="Samsung Logo" className={styles.brandLogo} />
            <h3>Samsung Smart Home</h3>
            <p>
            Intelligente Geräte und Innovationen, die Ihr Zuhause vernetzen und Ihren Alltag erleichtern. Optimale Lösungen für Unterhaltung, Sicherheit und Energieeffizienz.
            </p>
        </div>

        {/* Philips Smart Home */}
        <div className={styles.compatibilityItem}>
            <img src="/images/Philips.svg" alt="Philips Logo" className={styles.brandLogo} />
            <h3>Philips Smart Home</h3>
            <p>
                Innovative Beleuchtungssysteme und smarte Gesundheitslösungen für ein komfortableres und gesünderes Leben. Technologie, die Ihr Zuhause aufwertet.
            </p>
        </div>

        {/* Bosch Smart Home */}
        <div className={styles.compatibilityItem}>
            <img src="/images/Bosch.svg" alt="Bosch Logo" className={styles.brandLogo} />
            <h3>Bosch Smart Home</h3>
            <p>
            Modernste Haushaltsgeräte mit smarter Technologie, um Ihren Alltag effizienter und nachhaltiger zu gestalten. Qualität und Zuverlässigkeit für Ihr Zuhause.
            </p>
        </div>
    </div>
</section>
